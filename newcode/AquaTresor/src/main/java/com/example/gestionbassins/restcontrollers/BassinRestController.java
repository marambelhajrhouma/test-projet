...
public class BassinRestController {
   ...
   //à vérifier cette fonction aprés 
    ...
    public ResponseEntity<Bassin> addImageToBassin(@PathVariable Long bassinId, @RequestBody ImageBassin imageBassin) {
        Bassin updatedBassin = bassinService.addImageToBassin(bassinId, imageBassin);
